...
namespace llvm {
 ...
 /// successor.
 unsigned GetSuccessorNumber(const BasicBlock *BB,
 ...
 bool isCriticalEdge(const Instruction *TI, unsigned SuccNum,bool AllowIdenticalEdges) {
   ...
   if (getNumSuccessors(TI) == 1) return false;
 ...
 bool isPotentiallyReachable(const BasicBlock *A, const BasicBlock *B,
                                   const DominatorTree *DT, const LoopInfo *LI) {
