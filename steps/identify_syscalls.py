...
class Syscalls:
    ...
    def __init__(self, flag):
        ...
        #storage of all syscalls of the FreeRTOS and OSEK syscalls
        if flag == 0:
				self.syscalls = { 	
									# no syscall
									"Computation":1,
    ...
    #return all syscalls for the corresponding real time system
    def is_syscall(self, syscall):
		
		#get the isrs
		syscall = self.syscalls.get(syscall, "error")
		if syscall != "error":
