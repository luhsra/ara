...
class MutexSyscalls:
    ...
    def pthread_mutex_lock(graph, state, cpu_id, args, va):
        return add_edge_from_self_to(state, args.mutex, "pthread_mutex_lock()", cpu_id, expected_instance='Mutex')
    ...
    def pthread_mutex_unlock(graph, state, cpu_id, args, va):
        return add_edge_from_self_to(state, args.mutex, "pthread_mutex_unlock()", cpu_id, expected_instance='Mutex')