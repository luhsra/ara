...
class ZephyrStaticPost(Step):
    ...
    def read_autoconf(self):
        ...
        # Configs are just normal c macro defs: #define name value
        # NOTE: Macros always have a vlaue. Bools are either 0 or 1
        auto_conf = self.input_file.get()[:-3] + '_autoconf.h'
        config = {}
