...
#define PreIdleHook() __OS_HOOK_DEFINED_PreIdleHook(void)
...
#define StartupHook() __OS_HOOK_DEFINED_StartupHook(void)
...
#define PreTaskHook() __OS_HOOK_DEFINED_PreTaskHook(void)
...
#define PostTaskHook() __OS_HOOK_DEFINED_PostTaskHook(void)
...
#define ShutdownHook(status) __OS_HOOK_DEFINED_ShutdownHook(status)
...
#define FaultDetectedHook() __OS_HOOK_DEFINED_FaultDetectedHook(DetectedFault_t type, uint32_t arg1, uint32_t arg2)
