...
@.str = private unnamed_addr constant [13 x i8] c"Display Task\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"Buttons Thread\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"GPS Task\00", align 1
@.str.3 = private unnamed_addr constant [10 x i8] c"SD Thread\00", align 1
@.str.4 = private unnamed_addr constant [11 x i8] c"LED Thread\00", align 1

; Function Attrs: noinline optnone
define void @_Z7tmp_tmpv() #0 {
  %call = call i32 @xTaskCreate(void (i8*)* @_Z12vDisplayTaskPv, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i16 zeroext 768, i8* null, i32 2, %struct.tskTaskControlBlock** null)
  %call1 = call i32 @xTaskCreate(void (i8*)* @_Z14vButtonsThreadPv, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i16 zeroext 170, i8* null, i32 2, %struct.tskTaskControlBlock** null)
  %call2 = call i32 @xTaskCreate(void (i8*)* @_Z8vGPSTaskPv, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i16 zeroext 256, i8* null, i32 3, %struct.tskTaskControlBlock** null)
  ret void
}
...
; Function Attrs: noinline optnone
define void @_Z3tmpv() #0 {
  %call = call i32 @xTaskCreate(void (i8*)* @_Z9vSDThreadPv, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i16 zeroext 512, i8* null, i32 4, %struct.tskTaskControlBlock** null)
  %call1 = call i32 @xTaskCreate(void (i8*)* @_Z10vLEDThreadPv, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i16 zeroext 170, i8* null, i32 2, %struct.tskTaskControlBlock** null)
  call void @_Z7tmp_tmpv()
  ret void
}
...
define i32 @main() #2 {
  ...
  call void asm sideeffect "\09msr basepri, $0\09", "r,~{dirflag},~{fpsr},~{flags}"(i32 %2) #3, !srcloc !3
