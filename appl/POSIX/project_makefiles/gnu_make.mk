...
$(OBJ_BUILD)/gnu_make.ll: build_makefile_app.sh $(BUILD_DIR)/musl_libc.ll
	...
	@# Add $(COMPILE_WITH_MUSL_INCLUDE) to CFLAGS below if GNU make can be compiled with musl libc headers.
	@# Currently GNU make will be linked with musl libc but we need to use the glibc headers. This leads to inconsistency.
