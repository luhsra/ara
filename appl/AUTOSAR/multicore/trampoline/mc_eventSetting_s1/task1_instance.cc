/**
 * @file mc_eventSetting_s1/task1_instance.c
 *
...
TestRef t1_instance(void)
{
  ...
  EMB_UNIT_TESTCALLER(caller,"mc_eventSetting_s1",NULL,NULL,fixtures);
  return (TestRef)&caller;
}

/* End of file mc_eventSetting_s1/task1_instance.c */
