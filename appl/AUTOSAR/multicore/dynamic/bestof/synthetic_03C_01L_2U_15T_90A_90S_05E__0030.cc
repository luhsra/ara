...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask3 (void) {
  ...
  SetEvent(CPU1Task1Subtask13,EVENT2);
...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask6 (void) {
  ...
  SetEvent(CPU0Task3Subtask8,EVENT1);
  ...
  SetEvent(CPU2Task4Subtask14,EVENT4);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask6.6 sys_allowed=True inside_critical=False> x*/
