...
void AUTOSAR_TASK_FUNC_CPU1Task5Subtask0 (void) {
  ...
  SetEvent(CPU1Task5Subtask7,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task5Subtask11 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask11.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task3Subtask5 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task3Subtask5.4 sys_allowed=False inside_critical=True> x*/
