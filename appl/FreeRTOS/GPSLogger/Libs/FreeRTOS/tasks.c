...
extern uint32_t m_startInits;
extern uint32_t m_startSched;

void vTaskStartScheduler( void )
{
BaseType_t xReturn;

	uint32_t idle_create_time = CPU_CYCLES;
	...
	#endif /* configSUPPORT_STATIC_ALLOCATION */
	uint32_t idle_create_time_end = CPU_CYCLES;

	serialDebugWrite("\r\nstart_hardware_init: %d\r\nm_start_threadinits: %d\r\nm_startSched: %d\r\n",m_start, m_startInits, m_startSched);
	serialDebugWrite("idle start: %d\r\nide end: %d\r\n", idle_create_time, idle_create_time_end);
