...
#define M_E_D        2.71828182845904523536028747135      /* e */
#define M_LOG2E_D    1.44269504088896340735992468100      /* log_2 (e) */
#define M_LOG10E_D   0.43429448190325182765112891892      /* log_10 (e) */
#define M_SQRT2_D    1.41421356237309504880168872421      /* sqrt(2) */
#define M_SQRT1_2_D  0.70710678118654752440084436210      /* sqrt(1/2) */
#define M_SQRT3_D    1.73205080756887729352744634151      /* sqrt(3) */
#define M_PI_D       3.14159265358979323846264338328      /* pi */
#define M_PI_2_D     1.57079632679489661923132169164      /* pi/2 */
#define M_PI_4_D     0.78539816339744830961566084582      /* pi/4 */
#define M_2PI_D      6.28318530717958647692528676656      /* 2pi  */
#define M_SQRTPI_D   1.77245385090551602729816748334      /* sqrt(pi) */
#define M_2_SQRTPI_D 1.12837916709551257389615890312 /* 2/sqrt(pi) */
#define M_1_PI_D     0.31830988618379067153776752675      /* 1/pi */
#define M_2_PI_D     0.63661977236758134307553505349      /* 2/pi */
#define M_LN10_D     2.30258509299404568401799145468      /* ln(10) */
#define M_LN2_D      0.69314718055994530941723212146      /* ln(2) */
#define M_LNPI_D     1.14472988584940017414342735135      /* ln(pi) */
#define M_EULER_D    0.57721566490153286060651209008      /* Euler constant */

// Conversion macro
#define RAD2DEG(rad)            ((rad) * (180.0f / M_PI_F))
#define DEG2RAD(deg)            ((deg) * (M_PI_F / 180.0f))

#define RAD2DEG_D(rad)          ((rad) * (180.0 / M_PI_D))
#define DEG2RAD_D(deg)          ((deg) * (M_PI_D / 180.0))
